    ...
    <div className="mx-auto max-w-5xl px-4 py-10 sm:py-12">
      ...
      <div className="mt-8 grid gap-6 sm:mt-10 md:grid-cols-2 md:gap-8">
        <form
          ...
          className="space-y-3 rounded-3xl border-2 border-foreground bg-card p-5 sm:p-6"
        >
          <input
            required
            placeholder="Tu nombre"
            className="w-full rounded-full border-2 border-foreground bg-background px-4 py-3"
          />
          <input
            required
            type="email"
          ...
          <textarea
            ...
            className="w-full rounded-2xl border-2 border-foreground bg-background px-4 py-3"
          />
          <button className="sticker w-full rounded-full border-2 border-foreground bg-accent px-6 py-3 font-bold uppercase text-accent-foreground">
            Enviar mensaje
          </button>
        </form>
        <div className="space-y-3">
          <a
            ...
            className="flex items-center gap-3 rounded-2xl border-2 border-foreground bg-card p-4 hover:bg-muted"
          >
          ...
          <div className="flex items-center gap-3 rounded-2xl border-2 border-foreground bg-card p-4">
      ...
      <div className="mt-4 grid gap-2">
        {FAQS.map((item) => (
          <details key={item.q} className="rounded-2xl border-2 border-foreground bg-card p-4">

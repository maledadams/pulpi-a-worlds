    ...
    <div className="mx-auto max-w-5xl px-4 py-10 sm:py-12">
      ...
      <div className="mt-8 flex flex-wrap gap-4">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex w-fit items-center gap-3 rounded-2xl border border-foreground/15 bg-card p-4 transition hover:bg-muted"
        >
        ...
        <a
          href="https://instagram.com/pulpina.moon"
          target="_blank"
          rel="noreferrer"
          className="flex w-fit items-center gap-3 rounded-2xl border border-foreground/15 bg-card p-4 transition hover:bg-muted"
        >
          <Instagram className="h-5 w-5" />
          <span>@pulpina.moon</span>
        </a>

        <a
          href="https://instagram.com/pulpina.sunshine"
          target="_blank"
          rel="noreferrer"
          className="flex w-fit items-center gap-3 rounded-2xl border border-foreground/15 bg-card p-4 transition hover:bg-muted"
        >
          <Instagram className="h-5 w-5" />
          <span>@pulpina.sunshine</span>
        </a>
      ...
      <h2 className="mt-12 text-2xl sm:mt-16 sm:text-3xl md:text-4xl">Q&A</h2>
